...
class Dashboard:
    def __init__(self):
        ...
        self.mahasiswa_menu.add_command(label='Mahasiswa-Kalkulator Luas Persegi', command=lambda: self.new_window("Luas Persegi", FrmPersegi))
        self.mahasiswa_menu.add_command(label='Mahasiswa-Kalkulator Luas Segitiga', command=lambda: self.new_window("Luas Segitiga", FrmSegitiga))
        self.mahasiswa_menu.add_command(label='Mahasiswa-Kalkulator Luas Lingkaran', command=lambda: self.new_window("Luas Lingkaran", FrmLingkaran))
